 ...
 * The 0th key was pressed at the time 0, and every subsequent key was pressed
 * at the exact time the previous key was released.
 *
...
public class slowestKey {
     ...
     *
     * Runtime: 1 ms, faster than 64.38% of Java online submissions for Slowest Key.
     * Memory Usage: 39.3 MB, less than 17.95% of Java online submissions for Slowest Key.
     */
    ...
    public static void main(String[] args){
        ...
        String keysPressed1 ="ccbd";
        int[] releaseTimes2 = {12,23,36,46,62};
        String keysPressed2 ="spuda";

        System.out.println(slowestKey1(releaseTimes1,keysPressed1));
        System.out.println(slowestKey1(releaseTimes2,keysPressed2));
